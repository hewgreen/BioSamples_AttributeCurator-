...
if __name__ == '__main__':
	...
	with open(logname, 'w') as outF:
		...
		outF.write('End time: ' + end_timestamp + '\n\n')
		outF.write('Pairs missed: ' + missing_count + '\n')
		outF.write('Pairs previously computed: ' + already_computed_count + '\n')
		outF.write('Pairs computed in this run: ' + newly_computed_count + '\n')
		outF.write('Total pairs: ' + pairs_total_asNum + '\n')
